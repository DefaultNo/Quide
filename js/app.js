 ...
 */
    ...
    (() => {
        ...
        let slider = document.querySelector(".content-plans__range-item");
        const input = document.querySelector(".content-plans__input");
        if (slider) {
            ...
            input.addEventListener("input", (e => {
                setRangeSlider(input, e.currentTarget.value);
            }));
        ...
        function initSliders() {
            if (document.querySelector(".plans__swiper")) new core(".plans__swiper", {
                ...
                spaceBetween: 50,
                navigation: {
                    prevEl: ".plans__arrow_prev",
                    nextEl: ".plans__arrow_next"
                },
                pagination: {
            ...
            if (document.querySelector(".history__slider")) new core(".history__slider", {
                ...
                spaceBetween: 50,
                navigation: {
                    prevEl: ".history__controls .controls-slider__arrow_prev",
                    nextEl: ".history__controls .controls-slider__arrow_next"
                },
                pagination: {
                    el: ".history__controls .controls-slider__pagination",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".promo__body")) new core(".promo__body", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                spaceBetween: 50,
                navigation: {
                    prevEl: ".promo__controls .controls-slider__arrow_prev",
                    nextEl: ".promo__controls .controls-slider__arrow_next"
                },
                pagination: {
                    el: ".promo__controls .controls-slider__pagination",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".deposits__body")) new core(".deposits__body", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                spaceBetween: 50,
                navigation: {
                    prevEl: ".deposits__controls .controls-slider__arrow_prev",
                    nextEl: ".deposits__controls .controls-slider__arrow_next"
                },
                pagination: {
                    el: ".deposits__controls .controls-slider__pagination",
                    clickable: true
                },
                on: {}
            });
            if (document.querySelector(".withdrawal__slider")) new core(".withdrawal__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 1e3,
                navigation: {
                    prevEl: ".withdrawal .withdrawal-slider__arrow_prev",
                    nextEl: ".withdrawal .withdrawal-slider__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".open-deposit__slider")) new core(".open-deposit__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 1e3,
                navigation: {
                    prevEl: ".open-deposit .withdrawal-slider__arrow_prev",
                    nextEl: ".open-deposit .withdrawal-slider__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".content-dashboard__slider")) new core(".content-dashboard__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 1e3,
                navigation: {
                    prevEl: ".content-dashboard__slider .withdrawal-slider__arrow_prev",
                    nextEl: ".content-dashboard__slider .withdrawal-slider__arrow_next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".table-referals__swiper")) new core(".table-referals__swiper", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                speed: 1e3,
                navigation: {
                    prevEl: ".table-referals__swiper .controls-slider__arrow_prev",
                    nextEl: ".table-referals__swiper .controls-slider__arrow_next"
                },
                pagination: {
                    el: ".table-referals__swiper .controls-slider__pagination",
                    clickable: true
                },
                breakpoints: {
                    320: {
        ...
        const burgerTarget = document.querySelector(".header__burger"), burgerMenu = document.querySelector(".menu");
        if (burgerTarget) burgerTarget.addEventListener("click", (() => {
            burgerTarget.classList.toggle("_active");
            burgerMenu.classList.toggle("_active");
            document.body.classList.toggle("lock");
        }));
        const cabinetBurger = document.querySelector(".cabinet-header__burger"), cabinetNavigation = document.querySelector(".navigation"), overlay = document.querySelector(".overlay-bg");
        if (cabinetBurger) {
            function clearBurger() {
                cabinetBurger.classList.remove("_active");
                cabinetNavigation.classList.remove("_active");
                overlay.classList.remove("_active");
                document.body.classList.remove("lock");
            }
            document.addEventListener("click", (e => {
                if (e.target == overlay) clearBurger();
                if (e.target.closest(".navigation__burger")) clearBurger();
            }));
            cabinetBurger.addEventListener("click", (() => {
                cabinetBurger.classList.add("_active");
                cabinetNavigation.classList.add("_active");
                overlay.classList.add("_active");
                document.body.classList.add("lock");
            }));
        }
        if (document.querySelector(".open-deposit__plan")) {
            const slidePlans = document.querySelectorAll(".open-deposit__plan");
            function clearSelectPlan() {
                slidePlans.forEach((item => {
                    item.classList.remove("_select");
                }));
            }
            slidePlans.forEach((slidePlan => {
                slidePlan.addEventListener("click", (e => {
                    const targetItem = e.target;
                    if (targetItem.classList.contains("slide-plan__bottom")) {
                        clearSelectPlan();
                        slidePlan.classList.add("_select");
                    }
                }));
            }));
        }
